...
class RespondToWebhook {
    ...
    async execute() {
        ...
        try {
            ...
            const hasHtmlContentType = headers['content-type'] && (0, n8n_core_1.isHtmlRenderedContentType)(headers['content-type']);
            ...
            if (respondWith === 'json') {
                ...
                if (hasHtmlContentType || !headers['content-type']) {
                    responseBody = (0, n8n_core_1.sandboxHtmlResponse)(rawBody);
                }
                else {
            ...
            if (hasHtmlContentType &&
                ...
                respondWith !== 'binary' &&
                responseBody) {
                responseBody = (0, n8n_core_1.sandboxHtmlResponse)(JSON.stringify(responseBody));
            }
            response = {
                body: responseBody,
                headers,
