...
/**
 * Analytics Router - Business Analytics & Statistics (CLEAN VERSION)
  ...
  getOverview: businessProcedure
    .query(async ({ ctx }) => {
      ...
      try {
        ...
        const queryResult = await ctx.dbPool.query(analyticsQuery);
        ...
        notifyAnalyticsUpdate(responseData);
  ...
  getAutomationInsights: businessProcedure
    .query(async ({ ctx }) => {
      ...
      try {
        ...
        notifyInsightsUpdate(responseData);
  ...
  getIntegrationHealth: businessProcedure
    .query(async ({ ctx }) => {
      ...
      try {
        ...
        notifyHealthUpdate(responseData);
